...
function createPlaybackWidget(element, playbackControl) {
  ...
  function initialize() {
    ...
    currentTimeDisplay.innerText = hooks.utc(playbackControl.currentFrameIndex * 1000).format("HH:mm:ss");
    endTimeDisplay.innerText = hooks.utc(playbackControl.totalFrameCount * 1000).format("HH:mm:ss");
